...
public class SignService {
    ...
    public SignResDto login(SignReqDto request) throws Exception {
    ...
    public boolean register(SignReqDto request) throws Exception {
        try {
    ...
    public SignResDto getMember(String account) throws Exception {
        Member member = memberRepository.findByAccount(account)
                .orElseThrow(() -> new Exception("계정을 찾을 수 없습니다."));
        return new SignResDto(member);
    }
}
